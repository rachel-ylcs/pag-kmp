...
public class PAGLayer {
     ...
     * displaying.
     */
    public native void matrix(float[] value);
     ...
     * displaying.
     */
    public native void setMatrix(float[] value);
     ...
     */
    public native void getTotalMatrix(float[] value);
     ...
     */
    public native PAGRect getBounds();
